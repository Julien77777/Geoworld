  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <?PHP foreach ($lesContinents as $leContinent):?>
              <a class="dropdown-item" href="home.php?continent=<?PHP echo $leContinent ->Continent;?>" > <?PHP echo $leContinent->Continent ;?></a>
              <?PHP endforeach?>
          </div>
        </li>
      </ul>
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link" href="Utilisateur/login.html">Login</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="Utilisateur/register.html">Register</a>
        </li>
        <li class="nav-item">
